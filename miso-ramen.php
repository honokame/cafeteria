...
<body>
  ...
  <!--メニュー名-->
  <h5><?php echo $dayN[3]["menu"]; ?></h5>
  <br>
  <!--価格・カロリー情報-->
  <h6>¥<?php echo $dayN[3]["price"]; ?>&nbsp;&nbsp;&nbsp;カロリー：<?php echo $dayN[3]["cal"]; ?>kcal</h6>
  ...
  <div class="box25">
    <nobr>
      <div class="star-rating">
        <div class="star-rating-front" style="width: <?= $reviewD[0]["eval"] * 20 ?>%">★★★★★</div>
        <div class="star-rating-back">★★★★★
          &nbsp;<?php echo $reviewD[0]["body"]; ?></div>
    </nobr>
  </div>
  </div>
  </div>
  ...
  <div class="box26">
    <nobr>
      <div class="star-rating">
        <div class="star-rating-front" style="width: <?= $reviewD[1]["eval"] * 20 ?>%">★★★★★</div>
        <div class="star-rating-back">★★★★★
          &nbsp;
          <?php echo $reviewD[1]["body"]; ?></div>
    </nobr>
  </div>
  </div>
  </div>
  ...
  <div class="box27">
    <nobr>
      <div class="star-rating">
        <div class="star-rating-front" style="width: <?= $reviewD[2]["eval"] * 20 ?>%">★★★★★</div>
        <div class="star-rating-back">★★★★★
          &nbsp;
          <?php echo $reviewD[2]["body"]; ?></div>
    </nobr>
  </div>
  </div>
  </div>
  ...
  <div class="box28">
    <nobr>
      <div class="star-rating">
        <div class="star-rating-front" style="width: <?= $reviewD[3]["eval"] * 20 ?>%">★★★★★</div>
        <div class="star-rating-back">★★★★★
          &nbsp;
          <?php echo $reviewD[3]["body"]; ?></div>
    </nobr>
  </div>
  </div>
  </div>
  ...
  <div class="box29">
    <nobr>
      <div class="star-rating">
        <div class="star-rating-front" style="width: <?= $reviewD[4]["eval"] * 20 ?>%">★★★★★</div>
        <div class="star-rating-back">★★★★★
          &nbsp;
          <?php echo $reviewD[4]["body"]; ?></div>
    </nobr>
  </div>
  </div>
  </div>
  ...
  <div class="box30">
    <nobr>
      <div class="star-rating">
        <div class="star-rating-front" style="width: <?= $reviewD[5]["eval"] * 20 ?>%">★★★★★</div>
        <div class="star-rating-back">★★★★★
          &nbsp;
          <?php echo $reviewD[5]["body"]; ?>
        </div>
    </nobr>
  </div>
  </div>
