...
<body>
  ...
  <div class="Bset">
    <button class="button_B" type="submit" name="B" onclick="location.href='./Bset.php'"><img src="/team3/DesignImage/Bset.png" alt="送信" /></button>
    <p><b><?php echo $dayB["menu"]; ?></b></p>
  ...
  <div style="width:100%;margin-top:30px;">
    <div class="l-border l-p-t l-p-r l-p-b l-p-l" style="margin:10px 50px;padding:15px;;word-break:break-all;color:#333;box-shadow:1px 1px 2px rgba(0,0,0,0.3);background:url(https://stat.ameba.jp/user_images/20141029/18/wazameba/e8/9d/p/o0300030013113018873.png);border-radius:10px;">
      <div style="background:rgba(255,255,255,0.85);padding:5px;border-radius:5px;text-align:center;">
        <div style="border:2px dashed #545454;border-radius:5px;padding-top:30px;padding-bottom:30px;"><b><?php echo $weekA[0]["date"];?></b><br>Aセット：<?php echo $weekA[0]["menu"]; ?><br>Bセット：<?php echo $weekB[0]["menu"]; ?></div>
      </div>
    </div>
  </div>
  ...
  <div style="width:100%;margin-top:30px;">
    <div class="l-border l-p-t l-p-r l-p-b l-p-l" style="margin:10px 50px;padding:15px;word-break:break-all;color:#333;box-shadow:1px 1px 2px rgba(0,0,0,0.3);background:url(https://stat.ameba.jp/user_images/20141029/18/wazameba/e8/9d/p/o0300030013113018873.png);border-radius:10px;">
      <div style="background:rgba(255,255,255,0.85);padding:5px;border-radius:5px;text-align:center;">
        <div style="border:2px dashed #545454;border-radius:5px;padding-top:30px;padding-bottom:30px;"><b><?php echo $weekA[1]["date"];?></b><br>Aセット：<?php echo $weekA[1]["menu"]; ?><br>Bセット：<?php echo $weekB[1]["menu"]; ?></div>
      </div>
    </div>
  </div>
  ...
  <div style="width:100%;margin-top:30px;">
    <div class="l-border l-p-t l-p-r l-p-b l-p-l" style="margin:10px 50px;padding:15px;word-break:break-all;color:#333;box-shadow:1px 1px 2px rgba(0,0,0,0.3);background:url(https://stat.ameba.jp/user_images/20141029/18/wazameba/e8/9d/p/o0300030013113018873.png);border-radius:10px;">
      <div style="background:rgba(255,255,255,0.85);padding:5px;border-radius:5px;text-align:center;">
        <div style="border:2px dashed #545454;border-radius:5px;padding-top:30px;padding-bottom:30px;"><b><?php echo $weekA[2]["date"];?></b><br>Aセット：<?php echo $weekA[2]["menu"]; ?><br>Bセット：<?php echo $weekB[2]["menu"]; ?></div>
      </div>
    </div>
  </div>
  </div>
  ...
  <div style="width:100%;margin-top:30px;">
    <div class="l-border l-p-t l-p-r l-p-b l-p-l" style="margin:10px 50px;padding:15px;word-break:break-all;color:#333;box-shadow:1px 1px 2px rgba(0,0,0,0.3);background:url(https://stat.ameba.jp/user_images/20141029/18/wazameba/e8/9d/p/o0300030013113018873.png);border-radius:10px;">
      <div style="background:rgba(255,255,255,0.85);padding:5px;border-radius:5px;text-align:center;">
        <div style="border:2px dashed #545454;border-radius:5px;padding-top:30px;padding-bottom:30px;"><b><?php echo $weekA[3]["date"];?></b><br>Aセット：<?php echo $weekA[3]["menu"]; ?><br>Bセット：<?php echo $weekB[3]["menu"]; ?></div>
      </div>
    </div>
  </div>
  </div>
