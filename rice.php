...
<html lang="ja">
  <head>
    ...
    <title>明石高専学生食堂システム/ライス-詳細ページ</title>
  ...
  <body>
    ...
    <!--サブページ設定-->
    <!--menuImage-->
    <div class="MenuImage" style="text-align:center"><img src="イメージ/ライス.png" alt="menu"></div>
          ...
          <p style="margin-bottom: 1em;">
            ...
            <p style="margin-bottom:1em;">
              ...
              <p style="margin-bottom: 2em;">
                ...
                <input type="hidden" name="menu" value="ライス">
